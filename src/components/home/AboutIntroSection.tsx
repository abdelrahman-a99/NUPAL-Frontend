            ...
            <div className="relative overflow-hidden">
              ...
              <div className="relative ml-8">
                <div className="relative overflow-hidden rounded-3xl">
                  <img src="/nile4.jpg" alt="Nile University Campus" className="w-full h-auto object-cover rounded-3xl" style={{ maxHeight: '600px' }} />
          ...
          <div className="space-y-8">
            ...
            <div className="pt-8 border-t-2 border-slate-100">
              <div className="flex flex-wrap gap-6">
                <div className="flex items-center gap-3"><div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center"><span className="text-blue-400 text-sm font-bold">AI</span></div><span className="text-sm font-semibold text-slate-700">AI-Powered</span></div>
                <div className="flex items-center gap-3"><div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center"><span className="text-indigo-600 text-sm font-bold">P</span></div><span className="text-sm font-semibold text-slate-700">Personalized</span></div>
                <div className="flex items-center gap-3"><div className="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center"><span className="text-purple-600 text-sm font-bold">C</span></div><span className="text-sm font-semibold text-slate-700">Comprehensive</span></div>
                <div className="flex items-center gap-3"><div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center"><span className="text-blue-400 text-sm font-bold">I</span></div><span className="text-sm font-semibold text-slate-700">Intuitive</span></div>
              </div>
            </div>
          </div>
        </div>
